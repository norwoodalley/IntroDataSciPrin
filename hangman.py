    ...
    * After each guess, you should display to the user the 
    ...
    while 8 - mistake_made > 0:
        ...
        if word_guessed(secret_word, letters_guessed):
            print("-------------")
            print("(ᵒ̤̑ ₀̑ ᵒ̤̑)wow! Congratulations, you won!!! *✰*✲ﾟ*｡✧٩(･ิᴗ･ิ๑)۶*✲ﾟ*｡✧")
            break    
        else:
            print("-------------")
            ...
            if guess in letters_guessed:
                print("You already guessed that one, try again:",word_guessed(secret_word,letters_guessed))
                
            elif guess in secret_word and guess not in letters_guessed:
                letters_guessed.append(guess)
                print("Good guess, that letter is in my word."),word_guessed(secret_word,letters_guessed)
                
            else:
                letters_guessed.append(guess)
                mistake_made += 1
                print("（＊о＊）≡☆ Oops! That letter is not in my word:",word_guessed(secret_word,letters_guessed))
